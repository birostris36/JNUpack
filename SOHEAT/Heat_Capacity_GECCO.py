...
TEMP_nc=xr.open_dataset(nc_pth+'GECCO_TEMP_194801_201812.nc').loc[dict(Depth=slice(0,2000),time=slice('1980-01','2023-12'),lat=slice(-80,-10))]
SALT_nc=xr.open_dataset(nc_pth+'GECCO_SALT_194801_201812.nc').loc[dict(Depth=slice(0,2000),time=slice('1980-01','2023-12'),lat=slice(-80,-10))]
...
OHC.to_netcdf('D:/HEAT/GECCO_OHC_SO_c14_2000m_1980_2018.nc',format='netcdf4')
