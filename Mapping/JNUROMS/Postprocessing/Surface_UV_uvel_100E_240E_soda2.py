# -*- coding: utf-8 -*-
"""
Created on Tue May  2 08:15:39 2023
...
data_path='G:/SODA/'
w_path='D:/OneDrive/base142/Model_results/TK0525ED_CLM/Surface_UV_uvel_soda2/'
...
for z,i,j,ii,jj,tt in zip(Zeta,U_posi,V_posi,U_nega,V_nega,My_date): 
    ...
    plt.quiverkey(q1,290.,-19.,.5,"$5\cdot10^{-1} m/s$",coordinates='data',color='r',
