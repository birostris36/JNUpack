...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar 20 14:13:22 2023
...
save_name='ERA5_daily_vwind_1979_2022.nc'

nc=Dataset(read_path+'ERA5_vwind_S_1979_2022.nc')
...
def create_uwind_nc(nc_save_name,LON,LAT,TIME,Ref_time,values):
    ...
    time.units=Ref_time
    time.field='v-wind_time, scalar, series'

    Uwind = ncfile.createVariable('Vwind',np.float64,('wind_time','lat','lon'),\
                                zlib=False, fill_value=1e+20) #
    Uwind.units =  'meter secind-1'
    Uwind.long_name = 'surface v-wind component' # this is a CF standard name
    Uwind.time='wind_time'
    Uwind.coordinates = "lon lat"
    Uwind.field='v-wind, scalar, series'
