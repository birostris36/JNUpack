...
%
ROMS_title  = 'SO_05_lat2485';
ROMS_config = 'SO_05_lat2485';
SAVE_dir='D:/OneDrive/base142/Warehouse01/';
grdname  = [SAVE_dir,'Grd_05_SO_v3.nc'];
...
lonmin =  0.5;   % Minimum longitude [degree east]
lonmax =  359.5;   % Maximum longitude [degree east]
latmin =  -85;   % Minimum latitudeF  [degree north]
...
%
TOPODIR = '../';
topofile = ['D:/OneDrive/Sources/Data/Rtopo/RTopo-2.0.1_30sec_bedrock_topography.nc'];
% topofile = ['D:/OneDrive/Sources/Data/Etopo/etopo2.nc'];
...
%
oaname   = ['D:/OneDrive/Projects/ROMS/SO_02/Ini/','roms_oa.nc'];    % for climatology data processing
Zbryname = ['D:/OneDrive/Projects/ROMS/SO_02/Bry/','roms_bry_Z.nc']; % for boundary data processing
%
...
%
coads_dir=['D:/OneDrive/Sources/Data/COADS05/'];
%
% COADS time (for climatology runs)
%
% coads_time=(15.2083:30.4167:365); % days: middle of each month
% coads_cycle=365.25;        % repetition of a typical year of 360 days  
% coads_time=(15.:30.:360); % days: middle of each month
...
coads_cycle=365;                    % of QSCAT experiments with 
...
%
obc = [0 0 1 0]; % open boundaries (1=open , [S E N W])
%
...
woa_dir=['D:/OneDrive/Sources/Data/WOA2009/'];
%
...
%   monthly climatology 
%
% woa_time=(15:30:360); % days: middle of each month
