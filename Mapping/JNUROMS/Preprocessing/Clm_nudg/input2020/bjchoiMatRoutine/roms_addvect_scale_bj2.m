function han = roms_addvect_scale_bj(pos,uv,uscale,label,varargin)
...
hq = quiver(pos(1),pos(2)-0.2,uscale*uv(1),uscale*uv(2),0,varargin{:});
...
%set(ht,'horizontalalignment','right')  % original setting
