   ...
   if ( vpoint ==  1 )   
    ...
    for i=i1:i2
      ...
      for k=N:-1:lastlevel         % whole cell transport
          ...
          sum_fresh=sum_fresh+v(k,jj,i)*Hz_v(k,jj,i)*fresh_v(k,jj,i);
      end
