function [volume,heat,salinity] = xy_transport_onefile
% ====================================================================
...
% multifile   for mutiple  input files and single segment.
% BJ Choi, Marhch07, 2006.
    ...
    filename='his_eas_005_0001.nc';
    filename='avg_playhigh_00z_0225.nc';
    filename='avg_playhigh_05w_0245.nc';
    filename='avg_playhigh_05n_0246.nc';
    filename='avg_playhigh_05s_0246.nc';
    filename='avg_playhigh_05e_0245.nc';
...
if strcmpi(qq(1),'m');
  ...
  if isempty(f)
    ...
    disp('   or      -73.8771  40.5967 -73.9892  40.3977 for Raritan Bay line (in) ')
    disp('   or      -73.6953  40.6177 -74.0103  40.3981 for Raritan Bay line (out) ')
...
%   find path from corner_endpt(1) to corner_endpt(2)
  ...
  filetransport(fileloop)=total_fresh;
  disp([' freshwater volume transport = ', num2str(total_fresh) ,' m^3/s '])
 ...
 save -ascii xy_transport_fresh.dat outdata

 % New Jersey transect
 %% !mv xy_transport_fresh.dat  xy_transport_fresh_northNJ.dat 
 %% !mv xy_transport_fresh.dat  xy_transport_fresh_zeroNJ.dat 

 % Long Island transect
 %% !mv xy_transport_fresh.dat  xy_transport_fresh_northLI.dat 
 %% !mv xy_transport_fresh.dat  xy_transport_fresh_zeroLI.dat 


 %% !mv xy_transport_fresh.dat  xy_transport_fresh_northRB.dat 
 %% !mv xy_transport_fresh.dat  xy_transport_fresh_zeroRB.dat 

 % Hudson River source
 %% !mv xy_transport_fresh.dat  xy_transport_fresh_zeroHR.dat 
 %% !mv xy_transport_fresh.dat  xy_transport_fresh_northHR.dat  