function roms_2fli(varname,file,vover,frame_size,fli_file,frame_prefix)
% roms_2fli(varname,file,vover,frame_size,fli_file,frame_prefix)
%
...
%               or if vover is simply scalar it is interpreted as the
%               vover.scale value and the other options default
