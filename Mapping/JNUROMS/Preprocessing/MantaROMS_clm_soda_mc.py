...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 21 19:30:38 2023
...
def main(child_co):
    ...
    ncI['zeta'][Counter*12+child_co,:,:]=Rzeta
    # ncI['SSH'][:]=Rzeta
    ncI['temp'][Counter*12+child_co,:,:,:]=temp
    ncI['salt'][Counter*12+child_co,:,:,:]=salt
    ncI['u'][Counter*12+child_co,:,:,:]=u
    ncI['v'][Counter*12+child_co,:,:,:]=v
    ncI['ubar'][Counter*12+child_co,:,:]=ubar
    ncI['vbar'][Counter*12+child_co,:,:]=vbar
