# -*- coding: utf-8 -*-
"""
Created on Wed Apr 26 14:41:51 2023
...
Nega_cmap = ListedColormap(cmocean.cm.balance(np.linspace(0, .49, len(My_levels)+1,endpoint=True)))
Posi_cmap = ListedColormap(cmocean.cm.balance(np.linspace(.5, 1, len(My_levels)+1,endpoint=True)))
...
def Plot_SO_Merc2(MyDATA_uv,MyDATA_scalar,My_levels,CMAP,Mylim,w_path,save_name,fig_bool=False):
    ...
    q1 = plt.quiver(lon_posi,lat_posi,U_posi/Speed_posi,V_posi/Speed_posi,U_posi,
        scale=36,headwidth=7.5,headaxislength=10,headlength=13,color='k',
