# -*- coding: utf-8 -*-
"""
Created on Mon May  1 17:05:44 2023
...
q1 = plt.streamplot(lon_rho.data,lat_rho.data,U.data.data,V.data.data, density=10,transform=ccrs.PlateCarree())
plt.clim(0,Mylim[-1])
