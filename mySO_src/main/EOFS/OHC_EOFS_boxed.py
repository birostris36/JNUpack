...
wpth='C:/Users/shjo/OneDrive/mySO/EOFS_OHC/boxed/'
...
### define figure ====================================================
def myCrtpy_sph_pcolor_box(LAT,LON,DATA,CMAP,mylevel,myName,wpth,lat_rng,lon_rng):
...
for nm,lat_,lon_,eofs_,pcs_,var1_,var2_ in zip(myNm,myLat,myLon,myEofs,myPcs,myVar,myVar2):
    ...
    for eof,pc,var1,var2,N in zip(eofs_.values,pcs_.transpose(),var1_,var2_,range(1,len(eofs_)+1)):
        ...
        myCrtpy_sph_pcolor_box(latM,lonM,eof,CMAP,mylevel,t_nm,s_nm+'_eof',lat_rng_,lon_rng_)
        myCrtpy_sph_pcolor_box(latM,lonM,-eof,CMAP,mylevel,t_nm,s_nm+'_eof_re',lat_rng_,lon_rng_)
