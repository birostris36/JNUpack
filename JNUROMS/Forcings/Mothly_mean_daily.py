...
# -*- coding: utf-8 -*-
"""
Created on Thu Dec 29 14:44:25 2022
...
Var = 'dqdsst'
Name= 'ERA5_daily_'+Var+'_1993.nc'

r_path='/data4/base158/Warehouse01/daily/'
w_path= '/data4/base158/Warehouse01/tmp_monthly_1993/'
...
for i in ERA_list:
    ...
    if list(nc.variables.keys())[-1]=='Vwind':
        pass
    # nc.variables.keys()
    else :
        var_name=list(nc.variables.keys())[-1]
        time_name=list(nc.variables.keys())[-2]
        nc_save_name=w_path+'/ERA5_monthly_'+var_name+'.nc'
...
def Make_clm(nc,var_name,nc_save_name,time_name):
    ...
    ncfile.title='ERA5 1993 (1993 daily)'
