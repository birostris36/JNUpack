...
disp(' ')
disp(' Add topography...')
h=add_topo_Rtopo_Brock(grdname,topofile);
% Compute the mask

tmp='D:/OneDrive/Sources/Data/Rtopo/';
h_ice=add_topo_Rtopo_ice(grdname,'D:/OneDrive/Sources/Data/Rtopo/RTopo-2.0.1_30sec_ice_base_topography.nc');
