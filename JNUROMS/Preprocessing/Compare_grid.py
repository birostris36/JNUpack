# -*- coding: utf-8 -*-
"""
Created on Fri Jun  9 15:42:02 2023
...
lon_rng,lat_rng=[240,330],[-78,-50]

TKGRD=xr.open_dataset('G:/MODEL_DATA/TK_Inputs/roms_grd_sao025.nc')
MyGRD=xr.open_dataset('G:/MODEL_DATA/Grd/Grd_SO_05d_sponge.nc')
...
Plot_SO_Merc2(TK_lon_m,TK_lat_m,-TK_H,'',topo_CMAP,topo_lim,'','',False)


def Plot_SO_Merc2(lonA,latA,MyDATA,t_name,CMAP,Mylim,w_path,save_name,fig_bool=False):
    ...
    fig, ax = plt.subplots(1, 1, figsize=(12.5,4),
                       subplot_kw={'projection': MERC},dpi=150)
