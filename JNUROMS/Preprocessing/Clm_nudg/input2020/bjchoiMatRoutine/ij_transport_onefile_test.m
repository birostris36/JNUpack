...
% onefile   for single   input file  and single segment.
  ...
  if( nargin < 1)
%     filename='e:\case\ecsy10\2006\ncep\avg_ecsy10_blk_06_lmd_0004.nc';
    filename='e:\CDW_2011\avg_ecsy12_td_2011_kkl_v2_tpx6_a4_wt1_0213.nc';
    g = grd('ecsy12');
    selectdepth=100;
    %g = grd('eas');
    %g = grd('hudson');
...
%   load model output file
    ...
    zeta=nc{'zeta'}(1,:,:); % zeta(time, eta_rho, xi_rho)
