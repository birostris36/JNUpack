...
%out_file = 'ctz_lg_bndy2000July.nc';
 out_file = 'ctz_lg_bndy2000June_Aug.nc';
...
% endday  =183;  % July 1, 2000 
  startday=150;  % May  29, 2000
  endday  =245;  % Sep   1, 2000
...
sourcestr = [ 'From Globec-CCS 2000: 3km resolution, daily '];
details =   [ 'Quick boundary file from Globec-CCS 2000 daily mean ' ...
  ...
  for i=1:N 
    ...
    % =================================================== %
     ...
     if ( gn.mask_rho(j,i) > 0 ) % sea; we works on a cell under water
       ...
       izzr(1:nn)=iz0r+izeta.*(1.0 + z0r./gn.h(j,i));
