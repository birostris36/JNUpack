...
%   roms.Tobs_time = the times of the data
...
%   sbt_file = the data file that the subsurface analyses came from
%
...
%%%
% nc{theVarname}.cycle_length = 1461.;
nc{theVarname}.cycle_length = 2922.;
%%%
if exist('generic_tracer')
  if generic_tracer
