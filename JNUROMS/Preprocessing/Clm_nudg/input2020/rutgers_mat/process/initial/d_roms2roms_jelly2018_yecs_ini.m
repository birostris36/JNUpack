...
% Set file names.
run('/data/Lab/SCHA/MODEL/ROMS839/project/Jellyfish_nest/Make_yecs/rutgers_mat_sangchul/process/startup.m');
cd /data/Lab/SCHA/MODEL/ROMS839/project/Jellyfish_nest/Make_yecs/rutgers_mat_sangchul/process

fm_path = '/data/JHMoon/model/ROMS839/project/yecs15_auto/';

% NWAdata = [fm_path 'output/yecs15_his_0120.nc']; % 17/05/01 00H --> his 120, step 24
NWAdata = [fm_path 'output/yecs15_avg_0424.nc']; % 17/05/01 00H --> his 120, step 24
NWAgrid = [fm_path 'input/yecs15_grd2.nc'];

fp_path = '/data/Lab/SCHA/MODEL/ROMS839/project/Jellyfish_nest/INPUT/';
% GRDname = [fp_path 'Jelly2018_grd_d1.nc'];
GRDname = [fp_path 'Jelly2018_grd_d2_x3.nc'];

INIname = [fp_path 'Jelly2018_yecs_d2_ini_180301_natural_vlinear.nc'];
...
%  Set global attributes.
  ...
  avalue = 'Jelly2018 Model, ~1/300 resolution';
