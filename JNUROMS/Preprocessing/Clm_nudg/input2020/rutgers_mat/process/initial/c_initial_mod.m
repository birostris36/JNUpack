...
% svn $Id: c_initial.m 754 2015-01-07 23:23:40Z arango $
%=========================================================================%
...
Vname.salt        = 'salt';
Vname.NO3         = 'NO3';
Vname.phytoplanktonFe = 'phytoplanktonFe';
Vname.iron            = 'iron';
Vname.phytoplankton   = 'phytoplankton';
Vname.zooplankton     = 'zooplankton';
Vname.detritus        = 'detritus';
...
Var.name            = Vname.phytoplanktonFe;
Var.type            = nc_constant('nc_double');
Var.dimid           = [did.time did.Nr did.yr did.xr];
Var.long_name       = 'phytoplanktonFe';
...
Var.name            = Vname.detritus;
Var.type            = nc_constant('nc_double');
Var.dimid           = [did.time did.Nr did.yr did.xr];
Var.units           = 'mMol N m-3';
Var.long_name       = 'detritus';
Var.time      = Vname.time;
if (spherical),
  Var.coordinates   = strcat([Vname.rlon,' ',Vname.rlat,' ',            ...
                              Vname.s_rho,' ',Vname.time]); 
