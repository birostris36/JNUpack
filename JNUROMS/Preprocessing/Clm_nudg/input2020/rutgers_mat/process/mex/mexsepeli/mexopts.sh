...
# and followed by ':'.
#
# SELECTION_TAG_MEX_OPT: Template Options file for building MEX-files via the
#                        system ANSI compiler
#
# svn $Id: mexopts.sh 361 2009-07-02 15:43:20Z arango $
# Copyright 1984-2004 The MathWorks, Inc.
# $Revision: 361 $  $Date: 2009-07-03 00:43:20 +0900 (Fri, 03 Jul 2009) $
#----------------------------------------------------------------------------
#
    TMW_ROOT="$MATLAB"
    MFLAGS=''
...
#           gcc version 3.2.3
            ...
            CLIBS="$RPATH $MLIBS -lm /usr/lib64/libstdc++.so.5"
            COPTIMFLAGS='-O -DNDEBUG'
            CDEBUGFLAGS='-g'
#           
#           g++ -v
