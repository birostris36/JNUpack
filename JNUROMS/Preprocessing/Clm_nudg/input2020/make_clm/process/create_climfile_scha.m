function create_climfile_scha(clmname,grdname,title,...
                         theta_s,theta_b,hc,N,...
                         time,cycle,clobber,vtransform,vstretching);
...
[sc_r, Cs_r]=stretching(vstretching, ...
                             theta_s, theta_b, hc, N,           ...
			     0, 1); %JSHong, Rutgers

[sc_w, Cs_w]=stretching(vstretching, ...
                             theta_s, theta_b, hc, N,           ...
			     1, 1); %JSHong, Rutgers
