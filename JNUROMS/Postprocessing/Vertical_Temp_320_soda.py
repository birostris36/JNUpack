# -*- coding: utf-8 -*-
"""
Created on Tue May  2 10:23:49 2023
...
w_path_sig='D:/OneDrive/base142/Model_results/TK0525ED_CLM/vertical_temp_320_soda/'
save_name='Vertical_SODA_temp_lon320'
Tcline=300
fig_bool=1
...
lon_co=np.where( (LON>=319.8)&(LON<=320.3) )[0]
lat_co=np.where( (LAT>=-78)&(LAT<=-24) )[0]
...
MyCmap = ListedColormap(MyCmap(np.linspace(0, 0.95, len(My_levels)+1,endpoint=True)))
Label_size=13
t=0
