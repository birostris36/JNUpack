# -*- coding: utf-8 -*-
"""
Created on Tue May  2 08:23:33 2023
...
w_path='D:/OneDrive/base142/Model_results/TK0525ED_CLM/Surface_UV_uvel3/'
save_name='Surface_UV_uvel'

lat_rng,lon_rng=[-80,-23],[0,80]
...
for z,i,j,ii,jj,tt in zip(Zeta,U_posi,V_posi,U_nega,V_nega,My_date): 
    ...
    plt.quiverkey(q1,5.,-19.,.5,"$5\cdot10^{-1} m/s$",coordinates='data',color='r',
